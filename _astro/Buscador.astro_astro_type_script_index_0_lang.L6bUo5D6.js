import{n as e,t}from"./buscador.BX6MuzRD.js";var n=6,r=null,i=null;async function a(){return r||(i||=fetch(`/buscador.json`).then(e=>e.ok?e.json():[]).then(e=>r=e).catch(e=>(console.error(`[buscador] No se pudo cargar el índice:`,e),[])),i)}function o(t){let n=t.imagen?`<img src="${t.imagen}" alt="" loading="lazy" class="h-full w-full object-contain" />`:``,r=t.stock===`instock`?``:`<span class="font-mono text-[10px] text-muted">SIN STOCK</span>`,i=t.esVariable?`<span class="font-mono text-[10px] text-muted font-normal mr-1">Desde</span>`:``;return`
            <li>
                <a href="/producto/${t.id}" class="flex items-center gap-3 px-3 py-2.5 transition-colors hover:bg-surface-alt">
                    ...
                    <span class="flex shrink-0 flex-col items-end gap-0.5">
                        <span class="text-sm font-semibold text-green-700 tabular-nums">${i}${e(t.precio)}</span>
                        ${r}
                    </span>
                </a>
            </li>
